"""
bash train_refiner.sh -c 5 -s 6 -p 64 -e diffusion_refiner_oss -t oss1 -l 5e-5 -n 2000 -d flase -r /media/HDD/fanlinqian/work_dirs_refiner/Exp_refiner_OSS/20241108-1731037232-diffusion_refiner_oss -b /media/HDD/fanlinqian/work_dirs_othermodels/Exp_OSS/20241105-1730777670-swin_unetr
...
def keep_largest_components(segmentation, top_n=3):
    ...
    labeled_array, num_features = nlabel(segmentation)
    component_sizes = []
...
if __name__ == '__main__':
    ...
    shutil.copy('/home/suk/3dOssSeg/code/test_diffusion_refiner_oss.py', snapshot_path+'/test.py')
    ...
    # for it in np.arange(20400,184600,20400):
    #     ckpt_path = os.path.join(snapshot_path, f'ckpts/model_iter{it}.pth')
    for it in [61200]:
        ckpt_path = os.path.join(snapshot_path, f'ckpts/final_model.pth')
